...
- **Data: 08/06/26**  
  ...
  - A xogadora debería ser consciente das accións concretas que consumen tempo: cambio de sección, fallos no minixogo, recolectar plantas, falar
  - Audio de tic tac
  - Cambio de luz
...
- **Data: 08/06/26**  
  Haberá obxectos que:
  - Faciliten o minixogo
    - Tesoiras e vara: posibilitan algunha planta
    - Luva: facilita cortes de cousas que piquen
    - Cesto: dache máis capacidade no inventario.
      - Sen cesto: 6 herbas
      - Con cesto: 12 herbas
        - Se queremos, pode haber un supercesto de ouro de 18 herbas
    - Bicicleta: para moverte polo mapa. Mínimo 3ª xornada. Podes perdela cos anos
    - Caracola para saber escoitar o vento (buguina): pode darche información sobre os logros máis difíciles
    - Todos estos obxectos son fácilmente conseguibles pero hai que facer algo sinxelo como falar cunha persoa, explorar e atopalo, etc.
      - Obxectos máis secretos/difíciles:
        - súpercesto
...
- **Data: 08/06/26**  
  Pode haber “logros” extra por conseguir outros tipos de cacho con características concretas de algunhas herbas:
  - Cacho de bruxas: as plantas de bruxas é mellor recolectalas polas tardes
  - Cacho culinario
  - Cacho de saúde
  - Cachos de persoas (Maruja etc)  
    Estos cachos extras poden deixarnos anotacións ao longo do herbario, e tamén no resumo do final do día: “Deste cacho obtés o poema de Rosalía”  
    Estos cachos poden ser suxestións de personaxes que aparezan en xornadas concretas: cando tés 16 anos aparece Maruja e diche como facía o cacho na súa casa
- **Data: 08/06/26**  
  Varias persoas deixaron entrever que non se estaba entendendo moi ben de que ía o xogo. Tampouco cando terminaba
  - Que información e obxectivos debe ter o xogador e en que temporización?
    - Primeiro día: o xogador tén que saber que:
      - Tén que recoller plantas para facer o cacho ao rematar o día (entón terá que saber como recollelas)
...
- **Data: 08/06/26**  
  ...
  - Outras categorías (fichas)  
    Todo esto irase completando incrementalmente (pode ser atopándote coa herba, falando con xente, etc), cubrindo así a ficha de cada planta. **Para poder recolectar unha planta debes ter a identificación visual e nome.** (cando consigues as dúas dase un feedback visual e auditivo ¡xa podes recolectar a herba\!). A sección de “outras categorías”, que está recollida nas fichas, servirá para aumentar o valor do florilexio e do cacho.

- **Data: 08/06/26**  
  Outros:
  - Licor de xesta ou de toxo
  - Algunha planta de bruxa te hace flipar (easter egg de Augardentía)
  - O vento máis presente no xogo
  - Sistema de gardado: autogardado do día
  - Mapa con localizacións e marcadores ou indicadores no terreo? Dependerá do tamaño dos escenarios
